...
{target:`&lt;nav&gt;`, content:`ウェブページ内でユーザーがサイトを効果的に移動し、目的の情報にアクセスするのに役立つナビゲーションコンテンツを定義。<br>&lt;***&gt;...&lt;/***&gt;<br>&lt;***&gt;&lt;a href='#about'&gt;About&lt;/a&gt;&lt;/***&gt;`},
...
{target:`justify-content`, content:`フレックスコンテナーの主軸およびグリッドコンテナーのインライン軸に沿って、中身のアイテムの間や周囲に間隔を配置する方法を定義するCSSプロパティ。<br>display: flex<br>***: center;&emsp;space-between;&emsp;space-around;&emsp;space-evenly; `},
