...
{target:`&lt;aside&gt;`, content:`文書のメインコンテンツと間接的な関係しか持っていない文書の部分を表現するHTML要。サイドバーやコールアウトボックスなどを表現するのに使われる。<br>&lt;*** id'sidebar'&gt;&lt;/***&gt;`},
...
{target:`keyframes`, content:`アニメーションの流れに沿ったキーフレーム（または中間地点）のスタイルを定義することによって、一連の CSS アニメーションの中間ステップを制御します。これにより、アニメーションの中間ステップをトランジションよりも詳細に制御するCSSアットルール。<br>@*** fadeIn { ... }<br><br>&lt;ul class='fade'&gt; → 3つの画像を順番に表示<br>&emsp;&lt;li&gt;&lt;img src='img1.jpg' alt=''&gt;&lt;/li&gt;<br>&emsp;&lt;li&gt;&lt;img src='img2.jpg' alt=''&gt;&lt;/li&gt;<br>&emsp;&lt;li&gt;&lt;img src='img3.jpg' alt=''&gt;&lt;/li&gt;<br>&lt;/ul&gt;<br>@*** fade {<br>&emsp;0% {<br>&emsp;&emsp;opacity: 0;<br>&emsp;}<br>&emsp;15% {<br>&emsp;&emsp;opacity: 1;<br>&emsp;}<br>&emsp;30% {<br>&emsp;&emsp;opacity: 1;<br>&emsp;}<br>&emsp;45% {<br>&emsp;&emsp;opacity: 0;<br>&emsp;}<br>&emsp;100% {<br>&emsp;&emsp;opacity: 0;<br>&emsp;}<br>}<br>#main {<br>&emsp;animation: fade 15s infinite;<br>}`},
